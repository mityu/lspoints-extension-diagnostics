...
import * as textprop from "jsr:@mityu/lspoints-toolkit@^0.1.0/textprop";
import {
  defineDefaultLinks,
  HighlightLinkParams,
} from "jsr:@mityu/lspoints-toolkit@^0.1.0/highlight";
import {
  capitalize,
...
export class VirtualTextPublisher implements DiagnosticsPublisher {
  async initialize(denops: Denops) {
    const highlights = [
      ["LspointsDiagnosticsVirtualTextError", "Error"],
      ["LspointsDiagnosticsVirtualTextWarning", "WarningMsg"],
      ["LspointsDiagnosticsVirtualTextInformation", "Normal"],
      ["LspointsDiagnosticsVirtualTextHint", "Normal"],
