...
export class SignPublisher implements DiagnosticsPublisher {
  async initialize(denops: Denops) {
    const highlights = [
      ["LspointsDiagnosticsSignError", "Error"],
      ["LspointsDiagnosticsSignWarning", "WarningMsg"],
      ["LspointsDiagnosticsSignInformation", "Normal"],
      ["LspointsDiagnosticsSignHint", "Normal"],
